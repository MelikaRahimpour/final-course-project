                    ...
                    <>
                        <div className="flex items-center justify-between mt-3">
                            {
                                data.sale_price ?
                                    ...
                                    </div> : <span className="text-heading5 text-green-200">${data.price}</span>
                            }
                        </div>
                        <div className="mt-[15px] bg-gray-200 h-[4px] w-full rounded-[2px]">
                            <div style={{width: `${(data.sold / data.total) * 100}% `}} className="bg-green-200 h-[4px] w-3/4 rounded-[2px]"></div>
                        </div>
                        ...
                        <div className="mt-[23px]">
                            <button
                                ...
                                <IconBox icon={"icon-shopping-cart"} size={22}></IconBox>
