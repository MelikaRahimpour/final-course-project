            ...
            <div className="container flex items-center justify-between py-4 md:py-6 xl:py-8">
                ...
                <ul className="hidden lg:flex gap-5">
                    <li className="flex gap-2 cursor-pointer">
                        <IconBox icon={"icon-user"} size={24} link={'#'} title={"Account"} hideTitleOnMobile={true} titleClassName={"text-medium text-gray-500 font-lato ml-1"}/>
                    </li>
                    <li className="flex gap-2 cursor-pointer">
                        <IconBox icon={"icon-shopping-cart"} size={24} link={'#'} title={"Card"} hideTitleOnMobile={true} titleClassName={"text-medium text-gray-500 font-lato ml-1"}/>
                    </li>
                </ul>
            ...
            <div className="border-gray-200 border-y h">
                <div
                    ...
                    <div className="hidden lg:flex items-center shrink-0 gap-3">
                        <IconBox icon={"icon-headset xl:text-[32px] 2xl:text-[36px] aspect-square"} size={30}></IconBox>
                        <div>
                ...
                <div className="container flex justify-between lg:hidden pt-[20px] pb-[16px] items-end">
                    ...
                    <ul className="flex gap-5">
                        ...
                        <li className="flex gap-2 cursor-pointer">
                            <IconBox icon={"icon-shopping-cart"} size={24} link={'#'} title={"Card"} badge={5} hideTitleOnMobile={true} titleClassName={"text-medium text-gray-500 font-lato ml-1"}/>
                        </li>
                    </ul>
                </div>
            </div>
