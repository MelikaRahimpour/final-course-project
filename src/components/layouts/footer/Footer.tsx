            ...
            <div className="mb-[68px]">
                <div
                    ...
                    <div
                        ...
                        <div className="font-lato text-large tracking-[-0.04%] text-[#2B3D34] mt-8 hidden lg:block">Start Your
                            Daily Sopping with Nest Mart
                        </div>
                    </div>
            ...
            <div
                ...
                <div className="max-w-[346px]">
                    ...
                    <div className="flex items-start gap-2.5 mt-4 lg:mt-6">
                        ...
                        <div className="font-lato text-medium text-blue-300"><span className="font-bold">Address:</span> 5171 W
                    ...
                    <div className="flex items-start gap-2.5 mt-2 lg:mt-3">
                        ...
                        <div className="font-lato text-medium text-blue-300"><span className="font-bold">Call Us:</span> (+91) -
                            540-025-124553
                        </div>
                    </div>
                    <div className="flex items-start gap-2.5 mt-2 lg:mt-3">
                    ...
                    <div className="flex items-start gap-2.5 mt-2 lg:mt-3">
                        ...
                        <div className="font-lato text-medium text-blue-300"><span className="font-bold">Hours:</span> 10:00 -
                            18:00, Mon - Sat
                        </div>
                    </div>
                </div>
                <div className="pt-4 md:pt-0">
                    <div
                        className="flex text-heading6 md:text-heading5 lg:text-heading4 xl:text-heading4 text-blue-300 toggle">Company
                ...
                <div className="pt-4 md:pt-0">
                    <div
                        className="flex text-heading6 md:text-heading5 lg:text-heading4 xl:text-heading4 text-blue-300 toggle">Information <IconBox icon={"icon-down-dark inline-block sm:hidden"} size={24}/></div>
                    <ul className="hidden md:flex flex-col gap-2.5">
                ...
                <div className="pt-4 md:pt-0">
                    ...
                    <div className="font-lato text-small text-blue-300 mt-4 lg:mt-6">Install NetMart App from App Store or
                        Google Play
                    </div>
                    <div className="flex items-center gap-6 justify-center xl:justify-start pt-4 lg:pt-5">
                        <Link href="#"><ImageView src="/assets/images/va724oeh 1.png" alt={"Download app from apple store"} width={129}
                                                  height={39}/></Link>
                        <Link href="#"><ImageView src="/assets/images/17kw6njp 1.png" alt={"Download app from google play"} width={129}
                                                  height={39}/></Link>
                    </div>
                    <div className="font-lato text-small text-blue-300 text-center lg:text-left pt-4 lg:pt-5">Secured Payment
                        Gateways
                    </div>
